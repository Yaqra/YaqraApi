...
namespace YaqraApi.Services.IServices
{
    public interface ICommunityService
    {
        ...
        Task<GenericResultDto<PagedResult<ReviewDto>>> GetAllReviewsAsync(int page);
        ...
        Task<GenericResultDto<PagedResult<PlaylistDto>>> GetAllPlaylistsAsync(int page);
        ...
        Task<GenericResultDto<PagedResult<DiscussionArticlesNewsDto>>> GetAllDiscussionsAsync(int page, DiscussionArticleNewsTag tag);
        ...
        Task<GenericResultDto<PagedResult<ReviewDto>>> GetUserReviews(string userId, int page);
        Task<GenericResultDto<PagedResult<PlaylistDto>>> GetUserPlaylists(string userId, int page);
        Task<GenericResultDto<PagedResult<DiscussionArticlesNewsDto>>> GetUserDiscussions(string userId, int page);
        ...
        Task<GenericResultDto<PagedResult<CommentDto>>> GetPostCommentsAsync(int postId, int page);
